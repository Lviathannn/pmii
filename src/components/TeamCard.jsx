...
export default function TeamCard({ assetsId, name, position, facebook, instagram, linkedin }) {
    const { data } = useSWR(
        `https://cdn.contentful.com/spaces/8unu6a33e8sw/environments/master/assets/${assetsId}?access_token=moeWKcoJw5flx43XWBL1WebDZYsujWSzumlqcmaCXNQ`,
        fetcher
    );
